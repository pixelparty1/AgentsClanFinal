...
const socialLinks = [
  { icon: Twitter,   href: 'https://x.com/AgentsClan2',                                          label: 'X / Twitter' },
  { icon: Instagram, href: 'https://www.instagram.com/agents_clan2',                              label: 'Instagram'   },
  { icon: Linkedin,  href: 'https://www.linkedin.com/company/agents-clan/?viewAsMember=true',     label: 'LinkedIn'    },
  { icon: Youtube,   href: 'https://www.youtube.com/@AgentsClan2',                                label: 'YouTube'     },
];
